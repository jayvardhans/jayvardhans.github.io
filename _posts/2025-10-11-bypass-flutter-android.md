---
title: "Bypass Flutter Android Application"
categories:
- Mobile Application Penetration Testing
image:
  path: preview.png
layout: post
media_subpath: /assets/posts/2025-10-11-bypass-flutter-android
tags:
- SQL Injection
...
![configportandinterface](configportandinterface.png)

Now, In Request handling tab select Support invisible proxy.

![configinvisibleproxy](configinvisibleproxy.png)

Run the application, now data is intercepting.
